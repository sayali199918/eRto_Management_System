...
<h2 style="text-align:center;">eRTO System</h2>
<p style="text-align:center;">Welcome to the eRTO System.The place where transparency is the main moto.</p>
</div>
...
<div class="row">
  ...
  <div class="card bg-light " style="width:600px ; height:1350px">
    <div class="card-header" style="text-align:center;"><h5>Learning License</h5></div>
    <div class="card-body">
    
	<form:form method="post" modelAttribute="user_details" >
		 ...
		 <tbody>
			...
			<tr>
				...
				<td><form:select path="learningStatus" class="form-control">
				 <form:option value="BOOKED" label="BOOKED"/>
				 <form:option value="WRITTENSLOTISSUED" label="WRITTENSLOTISSUED"/>  
               
                 <form:option value="WRITTENTESTPASSED" label="WRITTENTESTPASSED"/>  
                 <form:option value="WRITTENTESTFAILED" label="WRITTENTESTFAILED"/> 
                 <!-- <form:option value="APPLIEDFORPERMANENT" label="APPLIEDFORPERMANENT"/> -->
                 <form:option value="COMPLETED" label="COMPLETED"/>
                 <form:option value="REJECTED" label="REJECTED"/>
                 </form:select>  
               </td>
				<td><form:errors path="learningStatus" /></td>
			</tr>
